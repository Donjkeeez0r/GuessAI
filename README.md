...
| Файл | О чём |
|---|---|
| [`CONTRACT.md`](CONTRACT.md) | **Источник правды.** Все REST-эндпоинты, WebSocket-события, формулы очков и ELO, поведение при разрывах связи. Расхождение кода с контрактом считается багом кода |
